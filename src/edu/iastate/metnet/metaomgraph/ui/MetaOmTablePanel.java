...
// fahmi - Limma analysis
    ...
    /**
     * This is the playback method for line-chart action. It takes the selected row ids, included
     * and excluded samples as the input, and produces the line-chart plot with those parameters,
     * mimicking the historically produced line-chart.
     */
    ...
    /**
     * This is the playback method for heat-map action. It takes the selected row ids, and produces
     * the heat-map, mimicking the historically produced heat-map. Before triggering the plot, the
     * MOGs samples are temporarily reset to the included samples of the historical action.
     */
    ...
    /**
     * This is the playback method for histogram action. It takes the selected row ids, included and
     * excluded samples as the input, and produces the histogram with those parameters, mimicking
     * the historically produced histogram. Before triggering the plot, the MOGs samples are
     * temporarily reset to the included samples of the historical action, so that the plot
...
//			}
    ...
    /**
     * This is the playback method for box-plot action. It takes the selected row ids, included and
     * excluded samples as the input, and produces the box-plot with those parameters, mimicking the
     * historically produced box-plot.
     */
    ...
    /**
     * This is the playback method for scatter-plot action. It takes the selected row ids, included
     * and excluded samples as the input, and produces the scatter-plot with those parameters,
     * mimicking the historically produced scatter-plot. Before triggering the plot, the MOGs
     * samples are temporarily reset to the included samples of the historical action.
     */
    ...
    /**
     * This is the playback method for line-chart-default-grouping action. It takes the selected row
     * ids, included and excluded samples as the input, and produces the line-chart-default-grouping
     * with those parameters, mimicking the historically produced line-chart-default-grouping.
     * Before triggering the plot, the MOGs samples are temporarily reset to the included samples of
     * the historical action, so that the plot considers them as the samples.
     */
    ...
    /**
     * This is the playback method for line-chart-choose-grouping action. It takes the selected row
     * ids, included and excluded samples as the input, and produces the line-chart-choose-grouping
     * with those parameters, mimicking the historically produced line-chart-choose-grouping. Before
     * triggering the plot, the MOGs samples are temporarily reset to the included samples of the
    ...
    /**
     * Group data into arrays and return a list of these arrays. Grouping is based on default rep
     * column
     *
     * @param groupsMap
     * @param sourceDataAll
     ...
     * @return
     *
     * @author urmi Group indices of data columns and create a list. Grouping is based on default
     * rep column. Return a list of shuffled indices to be used on data or wt matrix
     */
    ...
    /**
     * This is the playback method for correlation-histogram action. It takes the column value as
     * the input, and produces the correlation-histogram with those parameters, mimicking the
     * historically produced correlation-histogram.
     */
